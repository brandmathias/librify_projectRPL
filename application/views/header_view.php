...
<head>
  ...
  <title><?php echo $title_web;?> | Librify</title>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url('index.php/dashboard');?>" class="logo">
      ...
      <img src="<?php echo base_url('assets_style/image/librifynobg.png'); ?>" alt="Librify Logo" width="50" height="50">
    </a>
        ...
        <ul class="nav navbar-nav">
          <li>
            ...
            <a href="<?= base_url('user/edit/'.$idbo);?>">
              Welcome <?php echo $d->nama; echo ' | ( '.$d->level.' )'; ?></a>
          </li>
          <li>
